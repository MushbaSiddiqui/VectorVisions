  ...
  const advantages = [
    {
      ...
      description: "Precision in every pixel and stitch, ensuring your designs are perfect",
      icon: (
    ...
    {
      title: "All Required Formats",
      description: "Delivered in industry-standard formats ready for production",
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "Optimized for print and embroidery machines",
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "Quick delivery within 6-12 hours",
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <section className="py-20 px-4 bg-gray-50">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-4xl font-bold text-[#1A2238] mb-6">Why Work With Us</h2>
          <div className="w-20 h-1 bg-amber-500 mx-auto mb-6"></div>
          <p className="text-lg text-gray-700 max-w-3xl mx-auto">
            Experience excellence in every project with our commitment to quality and service
          </p>
        </motion.div>
